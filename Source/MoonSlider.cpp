...
MoonSlider::MoonSlider(gin::Parameter* parameter_) : gin::PluginSlider(parameter_, Slider::SliderStyle::RotaryVerticalDrag, Slider::NoTextBox), parameter(parameter_), value(parameter_)
{
