...
/*
*/
class EnvelopeComponent : public juce::Component, public gin::Parameter::ParameterListener
{
public:
    EnvelopeComponent(APAudioProcessor& proc_, int number) : proc(proc_), envelopeNumber(number)
    {
    ...
    void paint(juce::Graphics& g) override
    {
        ...
        float height = bounds.getHeight() - 5;
        juce::Path myPath;
