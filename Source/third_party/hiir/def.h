...
// Native word size, in power of 2 bits
	...
	#define hiir_WORD_SIZE_L2      (6)
	#define hiir_WORD_SIZE        (64)
	#define hiir_WORD_SIZE_BYTE    (8)
#else
	#define hiir_WORD_SIZE_L2      (5)
	#define hiir_WORD_SIZE        (32)
	#define hiir_WORD_SIZE_BYTE    (4)
#endif
