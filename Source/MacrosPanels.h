			...
			enableButton.onClick = [this]
				{
					if (row >= 0 && row < owner.assignments.size())
					{
						...
						auto e = owner.modMatrix.getModEnable(a.src, gin::ModDstId(a.dst->getModIndex()));
						owner.modMatrix.setModEnable(a.src, gin::ModDstId(a.dst->getModIndex()), !e);
			...
			biPolarButton.onClick = [this]
				{
					if (row >= 0 && row < owner.assignments.size())
					{
						...
						auto e = owner.modMatrix.getModBipolarMapping(a.src, gin::ModDstId(a.dst->getModIndex()));
						owner.modMatrix.setModBipolarMapping(a.src, gin::ModDstId(a.dst->getModIndex()), !e);
