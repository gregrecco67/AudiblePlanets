...
public:
	...
	struct GlobalParams {
		...
		gin::Parameter::Ptr mono, glideMode, glideRate, legato, level, mpe,
		    velSens, pitchbendRange;
	...
	struct CompressorParams {
		...
		gin::Parameter::Ptr enable, threshold, ratio, attack, release, knee,
		    input, output, type;
	...
	struct StereoDelayParams {
		...
		gin::Parameter::Ptr enable, timeleft, timeright, beatsleft, beatsright,
		    temposync, freeze, pingpong, feedback, dry, wet, cutoff;
	...
	struct ReverbParams {
		...
		gin::Parameter::Ptr enable, size, decay, damping, lowpass, predelay,
		    dry, wet;
	...
	struct MBFilterParams {
		...
		gin::Parameter::Ptr enable, lowshelffreq, lowshelfgain, lowshelfq,
		    peakfreq, peakgain, peakq, highshelffreq, highshelfgain, highshelfq;
	...
	struct RingModParams {
		...
		gin::Parameter::Ptr enable, modfreq1, shape1, mix1, modfreq2, shape2,
		    mix2, spread, lowcut, highcut;
	...
	struct MacroParams {
		...
		gin::Parameter::Ptr macro1, macro2, macro3, learning, macro1cc,
		    macro2cc, macro3cc;
		void setup(APAudioProcessor &p);
	...
	struct AuxParams {
		...
		gin::Parameter::Ptr enable, wave, env, octave, volume, detune, spread,
		    prefx, filtertype, filtercutoff, filterres, filterkeytrack,
		    ignorepb;
		void setup(APAudioProcessor &p);
	...
	gin::ModSrcId modSrcPressure, modSrcTimbre, modSrcMonoPitchbend, modSrcNote,
	    modSrcVelocity, modSrcVelOff, modSrcLFO1, modSrcLFO2, modSrcLFO3,
	    modSrcLFO4, modSrcMonoLFO1, modSrcMonoLFO2, modSrcMonoLFO3,
	    modSrcMonoLFO4, modSrcEnv1, modSrcEnv2, modSrcEnv3, modSrcEnv4,
	    modSrcModwheel, modPolyAT, modSrcMSEG1, modSrcMSEG2, modSrcMSEG3,
	    modSrcMSEG4, macroSrc1, macroSrc2, macroSrc3, randSrc1Mono,
	    randSrc1Poly, randSrc2Mono, randSrc2Poly;
	...
	juce::SmoothedValue<float, juce::ValueSmoothingTypes::Multiplicative>
	    laneAFilterCutoff, laneBFilterCutoff;
	...
	struct VizInfo {
		float defRat, epi1Rat, epi2Rat, epi3Rat, equant, defRad, epi1Rad,
		    epi2Rad, epi3Rad, algo;
	} viz, viz2;
